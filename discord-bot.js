...
function discordPayloads(message, options={}) {
  ...
  return chunks.map((content,index)=>({embeds:[new EmbedBuilder().setColor(0x7c3aed).setDescription(content)],components:index===chunks.length-1?buttons(options):[]}));
}
