...
bot.command('help', (ctx) => {
  ctx.reply([
    ...
    '',
    '⚔️ *RPG Commands:*',
    '   /rpg — Menu utama dunia RPG',
    '   /profile — Profil karakter',
    '   /helprpg — Panduan RPG lengkap',
    '   /world /campaign /explore — Dunia dan cerita',
    '   /skill /build /gear — Build karakter',
    '   /adventure — Dungeon panjang solo/duo',
    '   /coop — Pusat anonymous co-op',
    '   /party /guild — Fitur sosial',
    '   /worldboss /raid /tower — Endgame',
    '   /season /rank — Progress musiman',
    '',
    '💰 *Economy:*',
    '   /inv /shop /craft — Inventory dan crafting',
    '   /profession /salvage /refine — Profesi',
    '   /market — Marketplace anonim',
    '   /trade — Direct trade dua tahap',
    '',
...
const botCommands = [
  ...
  { command: 'adventure',description: '🏰 Dungeon panjang solo/duo' },
  { command: 'dungeon',  description: '👹 Dungeon dan raid co-op' },
  { command: 'party',    description: '👥 Party persisten' },
  { command: 'coop',     description: '🤝 Pusat anonymous co-op' },
  { command: 'guild',    description: '🏛️ Guild dan guild quest' },
  { command: 'duel',     description: '⚔️ PvP Duel' },
  { command: 'worldboss',description: '🌍 World Boss harian' },
  { command: 'raid',     description: '🔥 Weekly party raid' },
  { command: 'bounty',   description: '🎯 Duo bounty harian' },
  { command: 'coopcampaign', description: '🤝 Campaign bersama party' },
  { command: 'tower',    description: '🗼 Endless Tower' },
  { command: 'season',   description: '🏆 Progress season' },
  { command: 'rank',     description: '🥇 Leaderboard anonim' },
  { command: 'achievement', description: '🎖️ Achievement' },
  { command: 'collection', description: '📚 Koleksi item' },
